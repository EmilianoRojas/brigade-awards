...
const Snackbar: React.FC<SnackbarProps> = ({ message, type, onClose }) => {
    ...
    const styleOptions = {
        success: { bgColor: 'bg-green-600', Icon: CheckCircleIcon },
        error: { bgColor: 'bg-red-600', Icon: XCircleIcon },
        info: { bgColor: 'bg-blue-600', Icon: InformationCircleIcon },
    };

    const { bgColor, Icon } = styleOptions[type];
